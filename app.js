...
function renderRestaurantMenu() {
  ...
  // Yumi's real menu is divided into the same categories shown on its menu card.
  if (activeRestaurant.id === "rest-004") {
    ...
    menuMarkup = [...groups.entries()].map(([category, items]) => `
    ...
    menuMarkup = activeRestaurant.menu.map(renderMenuItem).join("");
  }
